...
loaded_model = pickle.load(
    open(os.path.join(module_path, r'model/recommendation_model.pkl'), 'rb'))


def getRecommendation(query_vector):
    ...
    recommended_songs = df_recommended[[
        "id", "similarity"]].to_dict(orient="records")
